...
class Owner(models.Model):
    ...
    phone_pure = PhoneNumberField("Нормализованный номер владельца", null=True, blank=True, db_index=True)
...
class Complaint(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="Кто пожаловался", related_name='complaints')
    flat = models.ForeignKey(Flat, on_delete=models.PROTECT, verbose_name="Квартира, на которую жаловались", related_name='complaints')
